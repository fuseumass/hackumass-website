...
export default function Faq() {
  ...
  const [faqs, _] = useState([
    ...
    ["Where is HackUMass XIV?", "HackUMass XIV is an in-person hackathon on the University of Massachusetts Amherst campus, with the main venue located at the Integrative Learning Center (650 N Pleasant St, Amherst, MA 01003)."],
    ["Who can attend?", "HackUMass XIV is open to ALL college students, including graduate students, regardless of major!"],
