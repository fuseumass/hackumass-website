...
export default function Faq() {
  ...
  const [faqs, _] = useState([
    ...
    ["Will my travel be reimbursed?", "If you applied early, you have the opportunity to apply for travel reimbursements by sending in an application. Reimbursements are limited so we can't grant them to every student, so we will review applications and make our judgement."],
