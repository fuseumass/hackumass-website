...
const SponsorsCard = ({ className = "", image15 }) => {
  useEffect(() => {
  ...
  return (
    <div
      className={`h-[156px] w-[323px] relative [&.animate]:animate-[1s_ease_0s_1_normal_forwards_fade-in-bottom] opacity-[0] ${className}`}
      data-animate-on-scroll
    >
